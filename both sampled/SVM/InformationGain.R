...
# Create an SVM model using 10-fold cross-validation
svm_model <- train(Attrition ~ ., data = train_data[, c(selected_features, "Attrition")], method = "svmRadial", trControl = train_control)
